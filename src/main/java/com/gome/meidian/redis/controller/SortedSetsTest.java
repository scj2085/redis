...
//		SortedSetsTest sortedSetsTest = new SortedSetsTest();
//		sortedSetsTest.testZadd();
//	}
//	
//	/** 
//     * 添加操作 
...
//        Map<String, Double> memberScore = new HashMap<String, Double>();  
...
//        memberScore = new HashMap<String, Double>();  
